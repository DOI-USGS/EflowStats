...
calc_timingLow <- function(x,yearType = "water",digits=3,pref="mean",floodThreshold=NULL,...) {
        #Check data inputs
        ...
        } else if (xbar<0) { # if x component is less than 0, arctan returns less than 180 but days should be 
