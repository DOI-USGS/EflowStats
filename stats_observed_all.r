...
namesMagStat <- c('ma1_mean_disc','ma2_median_disc','ma3_mean_annual_var','ma4','ma5_skew','ma6','ma7','ma8','ma9','ma10','ma11','ma12_jan_mean','ma13_feb_mean',
...
namesFlowStat <- c('fl1_low_flood_pulse','fl2_low_pulse_var','fl3','fh1_high_pulse_count','fh2_high_pulse_var','fh3_high_pulse_count_three',
                   'fh4_high_pulse_count_seven','fh5','fh6','fh7','fh8','fh9','fh10')
namesDurStat <- c('dl1_min_daily_flow','dl2_min_3_day_avg','dl3','dl4_min_30_day_avg','dl5_min_90_day_avg',
