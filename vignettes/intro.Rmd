...
Users with their own time series data can use the package as long as the data can be coreced into a `data.frame` with dates of class "Date" in the first column, and stream flow values of class "Numeric" in the second. The code below shows steps to calculate all hydrologic indices available from the package.
...
Deffinitions of the statistics calculated by EflowStats can be found in Henriksen et al, 2006 and Archfield et al., 2013 as well as in the package function documentation. Users who have used the hydroecological integrity assessment process software or previous versions of EflowStats may find slight differences in the output of the latest package. The package has undergone extensive review and every effort has been made to ensure faithful reproduction of the statistics as defined in Henriksen et al, 2006. Users interested in records of correspondence between the old package and the new package are directed to the summary in [this issue](https://github.com/USGS-R/EflowStats/issues/132) and the history of review documented in [other closed issues.](https://github.com/USGS-R/EflowStats/issues?q=is%3Aissue+is%3Aclosed)
